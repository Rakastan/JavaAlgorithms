...
import com.anakiou.ja.packing.RectPacker2.Rectangle2;


public class RectPacker<P> {
   ...
   */
  public RectPacker(int width, int height, int border) {
  ...
  public static void main (String[] args){
		...
		RectPacker<Integer> packer = new RectPacker<Integer>(640, 480, 0);
		Random r = new Random();
		
		
			packer.insert(20, 10, 1);
			packer.insert(20, 10, 2);
			packer.insert(20, 10, 3);
			packer.insert(20, 10, 4);
			packer.insert(20, 10, 5);
		
		List<Rectangle> rectangles = new ArrayList<Rectangle>();
		packer.inspectRectangles(rectangles);
		
		
		for(Rectangle rc : rectangles){
